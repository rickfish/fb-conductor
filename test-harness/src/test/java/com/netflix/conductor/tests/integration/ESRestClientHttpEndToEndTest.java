...
public class ESRestClientHttpEndToEndTest extends AbstractHttpEndToEndTest {
    ...
    public static void setup() throws Exception {
        ...
        JettyServer server = new JettyServer(SERVER_PORT, false, 16384);
        server.start();
    ...
    private static void waitForGreenCluster() throws Exception {
		...
		Request newRequest = new Request("GET", "/_cluster/health");
		newRequest.addParameter("wait_for_status", "green");
