...
public final class JerseyModule extends JerseyServletModule {
    ...
    protected void configureServlets() {
        ...
        bind(FBCommonConfiguration.class).to(SystemPropertiesFBCommonConfiguration.class);

        jerseyParams.put("com.sun.jersey.spi.container.ContainerResponseFilters","com.bcbsfl.filter.security.filters.ResponseFilter");
		jerseyParams.put("com.sun.jersey.spi.container.ContainerRequestFilters","com.bcbsfl.filter.security.filters.RequestFilter");
