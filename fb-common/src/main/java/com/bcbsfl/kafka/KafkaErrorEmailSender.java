...
import com.bcbsfl.mail.BasicEmailSender;
 ...
 *
 */
public class KafkaErrorEmailSender extends BasicEmailSender {
	...
	public KafkaErrorEmailSender() {
		super();
		this.errorsPerEmail = config.getKafkaEventsErrorsPerEmail();
		this.minutesUntilErrorEmail = config.getKafkaEventsMinutesUntilErrorEmail();
		this.currentErrors = Collections.synchronizedMap(new HashMap<String, AccumulatedErrors>());
		this.additionalRecipients = config.getKafkaEventsErrorEmailAddlRecipients();
