 ...
 *
 */
public class FBBaseCoreSystemPropertiesConfig implements FBBaseCoreConfig {

    private static Logger logger = LoggerFactory.getLogger(FBBaseCoreSystemPropertiesConfig.class);
